function Footer() {
  return (
    <footer className="bg-[#f3f3f12] dark:bg-[#0a0a0a]">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center w-full max-w-7xl mx-auto px-8 py-12 gap-6">
        ...
        <div className="flex gap-8">
          <a
            className="font-['Inter'] text-[0.875rem] text-[#474747] dark:text-[#a3a3a3] hover:underline decoration-1 underline-offset-4 transition-all duration-200"

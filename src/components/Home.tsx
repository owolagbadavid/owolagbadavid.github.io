  ...
  return (
    <section className="max-w-7xl mx-auto px-8 py-24 md:py-48 flex flex-col items-start" id="home">
      <div className="max-w-4xl">
        <span className="font-label text-xs uppercase tracking-[0.2em] text-on-surface-variant dark:text-[#a3a3a3] mb-6 block">
          BACKEND ENGINEER
        </span>
        <h1 className="text-6xl md:text-9xl font-extrabold tracking-[-0.04em] leading-[0.9] text-primary dark:text-[#ffffff] mb-12">
